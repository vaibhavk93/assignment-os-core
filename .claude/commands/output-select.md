...
4. Don't offer `interview-prep` here — it's opt-in via `/interview-prep`, chosen later once an interview is actually scheduled. Mention it exists; don't ask for a decision now.
