...
**Reads:** `workspace/recommendations.md`, `workspace/assumptions.md`, `workspace/synthesis.md`, `workspace/lenses.md`, `workspace/intent.md`, `workspace/context.md`.
...
## Returns
`{ "persona": "...", "status": "complete", "verdict": "...", "high_severity_count": N, "revision_areas": ["s3"] }`
